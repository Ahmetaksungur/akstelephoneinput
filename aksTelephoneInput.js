    ...
    var settings = $.extend(
      {
        ...
        flagsUrl: "https://unpkg.com/akstelephoneinput@1.0.0/flags/",
        searchBar: true
      },
      options
    );
    return this.each(function (i) {
    var flagUrl = settings.flagsUrl;
      function listCurrentHtml(current) {
        ...
        var html =
          '<div class="aks-TI-btn"><div class="aks-TI-btn-flag"><img src="' + flagUrl + current.countryCode +
          '.svg" alt="' +
          current.country +
      ...
      function listBtn(btn) {
        var html =
          ...
          '" data-country-number="' +
          btn.countryNumber +
          '" class="aks-TI-item" role="button"><div class="aks-TI-item-row"><div class="aks-TI-item-flag"><img src="'+ flagUrl +
          btn.countryCode +
          '.svg" alt="' +
          btn.country +
